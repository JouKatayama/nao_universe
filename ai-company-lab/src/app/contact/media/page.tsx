...
export const metadata: Metadata = {
  title: 'メディア取材のお問い合わせ',
  description: '取材・記事掲載に関するお問い合わせフォーム。',
}
  ...
  return (
    <>
      <section className="relative pt-28 pb-12 overflow-hidden">
        ...
        <div className="absolute top-20 right-0 w-[400px] h-[400px] rounded-full bg-purple-500/[0.03] blur-[100px] pointer-events-none" />
      ...
      <section className="py-12 md:py-16">
        <Container size="narrow">
          <ContactForm
            formType="media"
            fields={{
              organization: { label: '媒体名', placeholder: '○○新聞 / ○○メディア' },
            }}
          />
        </Container>
      </section>
