  ...
  return (
    <>
      <section className="relative pt-28 pb-12 overflow-hidden">
        ...
        <div className="absolute top-20 right-0 w-[400px] h-[400px] rounded-full bg-emerald-500/[0.03] blur-[100px] pointer-events-none" />
        <Container size="narrow">
          <div className="relative">
            ...
            <p className="text-text-secondary leading-relaxed">
              上記カテゴリに当てはまらないお問い合わせはこちらからお送りください。
            </p>
          </div>
        </Container>
      ...
      <section className="py-12 md:py-16">
        <Container size="narrow">
          <ContactForm formType="general" fields={{}} />
        </Container>
      </section>
    </>
  )
